...
const DestinationReviews: React.FC = () => {
    ...
    return (
        <section id="reviews" className="py-16 px-4 bg-white relative overflow-hidden">
            ...
            >
                {/* Section Title */}
                <motion.div className="mb-10" variants={titleVariants}>
                    <SectionTitle
                ...
                <motion.div className="hidden md:block" variants={cardVariants}>
                    ...
                    <div className="flex justify-center mt-10 items-center"> {/* Reduced margin from 12 to 10 */}
                        <button
                            ...
                            className={`p-2 rounded-full mr-4 cursor-pointer ${testimonialPage === 0
                        ...
                        <div className="flex space-x-3"> {/* Increased spacing from 2 to 3 */}
                            {[...Array(maxPage + 1)].map((_, index) => (
                                <button
                                    ...
                                    className={`w-3 h-3 rounded-full ${testimonialPage === index
                                        ? "bg-[var(--color-orange)]"
                        ...
                        <button
                            ...
                            className={`p-2 rounded-full ml-4 cursor-pointer ${testimonialPage === maxPage
                                ? "text-gray-400 cursor-not-allowed"
                                : "text-gray-700 hover:bg-gray-100"
                                }`}
                        >
