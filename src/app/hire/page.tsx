...
const HirePage = () => {
  ...
  return (
    <div className="relative overflow-hidden">
      <Head>
        <title>Careers | Join Our Team | Safari Sutra</title>
        <meta
          name="description"
          content="Build your career in travel with Safari Sutra. Explore current job openings and join our passionate team of travel specialists."
        />
        <meta
          name="keywords"
          content="safari sutra careers, travel jobs, tour guide jobs, travel industry careers, employment opportunities"
        />
        <link rel="canonical" href="https://thesafarisutra.com/hire" />
        <meta property="og:title" content="Careers | Join Our Team | Safari Sutra" />
        <meta
          property="og:description"
          content="Build your career in travel with Safari Sutra. Explore current job openings and join our passionate team of travel specialists."
        />
        <meta property="og:url" content="https://thesafarisutra.com/hire" />
